  ...
  static List<Pizza> getPizzas() {
    return [
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/margherita.png',
        price: 8.5,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/pepperoni.png',
        price: 9.5,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/4fromages.png',
        price: 10.0,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/hawaienne.png',
        price: 9.0,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/vegetarienne.png',
        price: 8.0,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/bbq_chicken.png',
        price: 10.5,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/mexicaine.png',
        price: 11.0,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/saumon_fume.png',
        price: 12.0,
      ...
      Pizza(
        ...
        imagePath: 'http://localhost/static/images/pizzas/tartiflette.png',
        price: 11.5,
